...
Window.load_resources do
  ...
  if flug == 1
    ...
    if Input.key_push?(K_SPACE) || Input.key_push?(K_ENTER)  || Input.key_push?(K_G) || Input.key_push?(K_RSHIFT)
     ...
     Window.draw_box_fill(20, 450, 30, 450 - guage * 4, gcolor)
     Window.draw_box_fill(20, 0, 30, 50, [0,0,0])     
    ...
    Sound[:music].stop
    Window.draw_font(250, 250, "FAILED...", Font.default, color: C_WHITE)
  end
end
end